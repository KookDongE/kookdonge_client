    ...
    case 'fire':
      return (
        ...
        >
          <path
            fillRule="evenodd"
            d="M12.963 2.286a.75.75 0 00-1.071-.136 9.742 9.742 0 00-3.539 6.177A7.547 7.547 0 018 9.5a7.547 7.547 0 010-1.5 9.742 9.742 0 003.539-6.177.75.75 0 00-1.07.136 8.963 8.963 0 013.394 6.17 8.963 8.963 0 01-3.394 6.17z"
            clipRule="evenodd"
          />
        </svg>
      );
