                    ...
                    <div className="mt-1 flex items-center gap-2 text-xs text-zinc-400 dark:text-zinc-500">
                      ...
                      {(commentLikeOverrides[root.id] ?? root.likeCount) > 0 && (
                        <span className="flex items-center gap-0.5" aria-label={`좋아요 ${commentLikeOverrides[root.id] ?? root.likeCount}개`}>
                          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="h-3.5 w-3.5 text-red-500 dark:text-red-400">
                            <path d="M11.645 20.91l-.007-.003-.022-.012a15.247 15.247 0 01-.383-.218 25.18 25.18 0 01-4.244-3.17C4.688 15.36 2.25 12.174 2.25 8.25 2.25 5.322 4.714 3 7.688 3A5.5 5.5 0 0112 5.052 5.5 5.5 0 0116.313 3c2.973 0 5.437 2.322 5.437 5.25 0 3.925-2.438 7.111-4.739 9.256a25.175 25.175 0 01-4.244 3.17 15.247 15.247 0 01-.383.219l-.022.012-.007.004-.003.001a.752.752 0 01-.704 0l-.003-.001z" />
                          </svg>
                          <span>{commentLikeOverrides[root.id] ?? root.likeCount}</span>
                        </span>
                      )}
                    </div>
                  </div>
                    ...
                    >
                      ...
                      <div className="relative z-[1] flex min-w-0 flex-1 flex-wrap gap-2 rounded-lg bg-zinc-50 py-2 px-3 dark:bg-zinc-800/50">
                        ...
                        <div className="w-full -mt-3">
                          ...
                          {likeCount > 0 && (
                            <span className="flex items-center gap-0.5" aria-label={`좋아요 ${likeCount}개`}>
                              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="h-3.5 w-3.5 text-red-500 dark:text-red-400">
                                <path d="M11.645 20.91l-.007-.003-.022-.012a15.247 15.247 0 01-.383-.218 25.18 25.18 0 01-4.244-3.17C4.688 15.36 2.25 12.174 2.25 8.25 2.25 5.322 4.714 3 7.688 3A5.5 5.5 0 0112 5.052 5.5 5.5 0 0116.313 3c2.973 0 5.437 2.322 5.437 5.25 0 3.925-2.438 7.111-4.739 9.256a25.175 25.175 0 01-4.244 3.17 15.247 15.247 0 01-.383.219l-.022.012-.007.004-.003.001a.752.752 0 01-.704 0l-.003-.001z" />
                              </svg>
                              <span>{likeCount}</span>
