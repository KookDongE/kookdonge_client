...
export default function SplashPage() {
  ...
  return (
    <div className="flex h-dvh min-h-0 flex-col items-center justify-center overflow-hidden bg-[var(--background)]">
      <motion.div
      ...
      >
        <div className="flex h-20 w-20 items-center justify-center rounded-2xl bg-blue-500 dark:bg-lime-400">
