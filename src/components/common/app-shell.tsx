...
const HEADER_HIDDEN_PATHS = ['/', '/login', '/welcome', '/mypage/clubs/apply', '/admin/community/write'];
...
/** 풀투리프레시 비활성화 경로 (피드 상세, 피드 생성/수정, 버그 신고, 동아리 신청, 설정, 알림설정, 글쓰기 — 스크롤·제스처와 충돌 방지) */
const PULL_TO_REFRESH_DISABLED_PATHS = [
  ...
  /^\/admin\/community\/write$/, // 글쓰기 페이지 (당길 때 콘텐츠 움직임 방지)
];
