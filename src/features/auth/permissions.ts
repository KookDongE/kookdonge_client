...
/** 시스템 관리자(ADMIN) 여부. 관리자 페이지·하단 탭·동아리 카드 스와이프(삭제)에 사용 */
...
export function isClubManager(profile: UserProfileRes | null | undefined, clubId: number): boolean {
